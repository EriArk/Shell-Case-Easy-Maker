...
- [x] Glass recess placement polish with face-local picking/snapping.
- [x] Manual button group placement polish with face-local picking/snapping.
...
- [x] Basic sketch rectangle nudge/delete actions.
- [x] Basic sketch rectangle bounds warning.
- [x] Basic sketch rectangle click-to-place mode.
- [x] Basic sketch rectangle resize buttons.
- [x] Basic sketch rectangle move-to-click mode.
