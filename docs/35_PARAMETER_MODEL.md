...
movement stays a semantic undoable edit. When a supported sketch workplane size
is available, the adapter can also report a warning if the rectangle extends
